...
const exp = [
  ...
  },
  {
    ...
    desp: "<li>Worked as a Java Full Stack Developerr.</li><li>Worked in a Banking product, where my work is to implement the payment specific modules.</li>",
  },
  {
    title: "Software Engineer",
    cardImage: "assets/images/experience-page/newgen.png",
    place: "Chennai",
    time: "(Sep, 2016 - Jan, 2019)",
    desp:"<li>Worked as a Java developer and develops newgen BPM products.</li><li>We customize and provide the newgen BPM products to their clients as per the given requirement.</li>",
  },
];
